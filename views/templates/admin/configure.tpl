<div id="seooptimizer">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="#tab-audit-heading-hierarchy" role="button" data-toggle="collapse">
                                    <i class="icon-header"></i>
                                    {l s='Heading hierarchy (H1-H6)' mod='seooptimizer'}
                                </a>
                            </li>
                            <li>
                                <a href="#tab-audit-missing-alt" role="button" data-toggle="collapse">
                                    <i class="icon-picture"></i>
                                    {l s='Missing image alt' mod='seooptimizer'}
                                </a>
                            </li>
                            <li>
                                <a href="#tab-audit-broken-links" role="button" data-toggle="collapse">
                                    <i class="icon-unlink"></i>
                                    {l s='Broken links (404)' mod='seooptimizer'}
                                </a>
                            </li>
                            <li>
                                <a href="#tab-audit-page-load-time" role="button" data-toggle="collapse">
                                    <i class="icon-dashboard"></i>
                                    {l s='Page load time' mod='seooptimizer'}
                                </a>
                            </li>
                            <li>
                                <a href="#tab-audit-page-weight" role="button" data-toggle="collapse">
                                    <i class="icon-hdd-o"></i>
                                    {l s='Page weight' mod='seooptimizer'}
                                </a>
                            </li>
                            <li>
                                <a href="#tab-audit-unsecured-links" role="button" data-toggle="collapse">
                                    <i class="icon-unlock"></i>
                                    {l s='Unsecured links (HTTP)' mod='seooptimizer'}
                                </a>
                            </li>
                            <li>
                                <a href="#tab-audit-meta-tags" role="button" data-toggle="collapse">
                                    <i class="icon-align-left"></i>
                                    {l s='Meta tags (title & description)' mod='seooptimizer'}
                                </a>
                            </li>
                            <li>
                                <a href="#tab-audit-internal-links" role="button" data-toggle="collapse">
                                    <i class="icon-link"></i>
                                    {l s='Internal links' mod='seooptimizer'}
                                </a>
                            </li>
                            <li>
                                <a href="#tab-audit-text-ratio" role="button" data-toggle="collapse">
                                    <i class="icon-font"></i>
                                    {l s='Text content ratio' mod='seooptimizer'}
                                </a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="#tab-pages" role="button" data-toggle="collapse">
                            <i class="icon-file-text"></i>
                            {l s='Pages' mod='seooptimizer'}
                        </a>
                    </li>
                    <li class="seoo-navbar-separator"></li>
                    <li>
                        <a href="#tab-redirects" role="button" data-toggle="collapse">
                            <i class="icon-share"></i>
                            {l s='Redirections' mod='seooptimizer'}
                        </a>
                    </li>
                    <li>
                        <a href="#tab-indexations" role="button" data-toggle="collapse">
                            <i class="icon-database"></i>
                            {l s='Indexations' mod='seooptimizer'}
                        </a>
                    </li>
                    <li>
                        <a href="#tab-not-found" role="button" data-toggle="collapse">
                            <i class="icon-unlink"></i>
                            {l s='Pages not found' mod='seooptimizer'}
                        </a>
                    </li>
                    <li>
                        <a href="#tab-robots-txt" role="button" data-toggle="collapse">
                            <i class="icon-file-text"></i>
                    ...
                    <li>
                        <a href="#tab-sitemap" role="button" data-toggle="collapse">
                    ...
                    <li>
                        <a href="#tab-rich-snippets" role="button" data-toggle="collapse">
                            <i class="icon-star"></i>
                            {l s='Rich snippets' mod='seooptimizer'}
                        </a>
                    </li>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="#tab-verification-code" role="button" data-toggle="collapse">
                                    <i class="icon-code"></i>
                                    {l s='Verification code' mod='seooptimizer'}
                                </a>
                            </li>
                            <li>
                                <a href="#tab-social-configuration" role="button" data-toggle="collapse">
                                    <i class="icon-cloud"></i>
                                    {l s='Social addresses' mod='seooptimizer'}
                                </a>
                            </li>
                            <li>
                                <a href="#tab-link-obfuscator" role="button" data-toggle="collapse">
                                    <i class="icon-link"></i>
                                    {l s='Links obfuscation' mod='seooptimizer'}
                                </a>
                            </li>
                        </ul>
                    </li>
                    <li class="seoo-navbar-separator"></li>
                    <li>
                        <a href="#tab-settings" role="button" data-toggle="collapse">
                            <i class="icon-cogs"></i>
                            {l s='Configuration' mod='seooptimizer'}
                        </a>
                    </li>
                </ul>
    ...
    <div id="tabs">
                        ...
                        {foreach $seoo_scores.audits as $audit_key => $audit_data}
                            <div class="seoo-dashboard-score__audit seoo-dashboard-score__audit--{$audit_data.grade_color|escape:'htmlall':'UTF-8'}">
                                ...
                                <div class="seoo-dashboard-score__audit-info">
                                    <span class="seoo-dashboard-score__audit-title">
                                        <i class="{$audit_data.icon|escape:'htmlall':'UTF-8'}"></i>
                                        {$audit_data.title|escape:'htmlall':'UTF-8'}
                                    </span>
                        ...
                        <div class="seoo-panel-intro">
                            <div class="seoo-panel-intro__content">
                                <h3 class="seoo-panel-intro__title">
                                    <i class="icon-list"></i>
                                    {l s='Score by page' mod='seooptimizer'}
                                </h3>
                            ...
                            <table class="table seoo-pages-score-table">
                                <thead>
                                    <tr>
                                        ...
                                        {foreach $seoo_scores.audits as $audit_key => $audit_data}
                                            <th class="seoo-pages-score-table__th-audit text-center" title="{$audit_data.title|escape:'htmlall':'UTF-8'}">
                                                <i class="{$audit_data.icon|escape:'htmlall':'UTF-8'}"></i>
                                            </th>
                                        {/foreach}
                                    </tr>
                                ...
                                <tbody>
                                    {foreach $seoo_scores.pages as $page_url => $page_data}
                                        <tr>
                                            <td class="seoo-pages-score-table__grade">
                                                <span class="seoo-grade-badge seoo-grade-badge--{$page_data.grade_color|escape:'htmlall':'UTF-8'}">{$page_data.grade|escape:'htmlall':'UTF-8'}</span>
                                            </td>
                                            <td class="seoo-pages-score-table__url">
                                                <a href="{$page_data.url|escape:'htmlall':'UTF-8'}" target="_blank" rel="noopener">{$page_data.url|escape:'htmlall':'UTF-8'}</a>
                                            </td>
            ...
            <div class="container-fluid panel">
                <div class="row">
                    <div class="col-xs-12 col-md-4">
                        <canvas class="chart-bar" id="chart_pages_not_found" data-chart="pages_not_found"></canvas>
                    </div>
            ...
            <div class="panel">
                <div class="seoo-panel-intro">
                    ...
                    <div class="seoo-panel-intro__actions">
                        <button class="btn btn-default" data-toggle="collapse" data-target="#form-redirection-edit">
                            <i class="icon-plus"></i> {l s='Add new redirection' mod='seooptimizer'}
                        </button>
                        <button class="btn btn-default" data-toggle="collapse" data-target="#form-redirection-import">
                            <i class="icon-upload"></i> {l s='Import' mod='seooptimizer'}
                        </button>
                        <a href="{$seoo_export_redirections_url|escape:'htmlall':'UTF-8'}" class="btn btn-default">
                            <i class="icon-download"></i> {l s='Export' mod='seooptimizer'}
                        </a>
                    </div>
                </div>
            </div>

            <div id="form-redirection-edit" class="collapse {if isset($show_form_redirection_edit)}in{/if}">
                {$form_redirection_edit}
            </div>
            <div id="form-redirection-import" class="collapse {if isset($show_form_redirection_import)}in{/if}">
        ...
        <div id="tab-indexations" class="tab collapse">
            <div class="panel">
                <div class="seoo-panel-intro">
                    ...
                    <div class="seoo-panel-intro__actions">
                        <button class="btn btn-default" data-toggle="collapse" data-target="#form-indexation-rule">
                            <i class="icon-plus"></i> {l s='Add new rule' mod='seooptimizer'}
                        </button>
                    </div>
                </div>
            </div>

            <div id="form-indexation-rule" class="collapse {if isset($show_form_indexation_rule)}in{/if}">
        ...
        <div id="tab-social-configuration" class="tab collapse">{$form_social}</div>
        <div id="tab-sitemap" class="tab collapse">{$form_sitemap}</div>
        <div id="tab-link-obfuscator" class="tab collapse">{$form_link_obfuscator}</div>
